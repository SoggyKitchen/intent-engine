...
<p>Our <a href="/methodology">full methodology page</a> explains how we evaluate software tools. We work from vendors' published pricing pages, plan documentation and terms, and we link to the source for every figure. We do not run usability, performance or deliverability testing, and we do not present vendor materials as our own hands-on findings.</p>
