...
<ul>
  ...
  <li>Email sequence automation is among the best we compared</li>
</ul>
...
<p>Pipedrive was built by salespeople and it shows. The pipeline view, activity tracking, and deal progression workflow is the most intuitive we compared. It's not trying to be a marketing platform.</p>
<p><strong>What we found in testing:</strong></p>
<ul>
