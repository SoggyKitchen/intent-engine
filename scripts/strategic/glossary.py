...
TERMS = [
    ("ACV", "Annual Contract Value — the annualised revenue of a customer contract. SaaS vendors report ACV to smooth out multi-year deals."),
    ("ARR", "Annual Recurring Revenue — total subscription revenue normalised to 12 months. The primary SaaS growth metric."),
    ("ARPU", "Average Revenue Per User — total revenue divided by active users. Used to measure monetisation efficiency."),
    ...
    ("CAC", "Customer Acquisition Cost — total sales + marketing spend divided by new customers acquired. CAC payback under 12 months is ideal for SaaS."),
    ...
    ("Net Dollar Retention", "NDR — revenue from existing customers vs. one year ago. 120%+ is elite SaaS."),
    ...
    ("SAML", "Security Assertion Markup Language — protocol for SSO. Required for most enterprise IT approvals."),
    ("SLA", "Service Level Agreement — contractual uptime guarantee. 99.9% = ~8.76h downtime/year; 99.99% = ~52min/year."),
    ("TAM", "Total Addressable Market — maximum revenue opportunity if 100% of potential customers bought."),
...
<section class="page-hero">
  ...
  <div class="page-hero-content">
    ...
    <div class="page-eyebrow">Reference · {len(TERMS)} terms</div>
    <h1>{h1}</h1>
