...
PRICING = {
    ...
    "ramp": dict(
        ...
        meta_desc="Ramp pricing 2026 change log: Core card free forever (no price hike since launch). Plus $15/user/mo or $12/mo annual. Every change tracked and dated with source.",
        plans=[
