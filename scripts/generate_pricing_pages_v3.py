...
PRICING = {
    ...
    "mixpanel": dict(
        ...
        meta_desc="Mixpanel pricing 2026: Free (20M events/mo), Growth from $28/mo (100M events), Enterprise custom. Full cost breakdown — the event-volume trap that catches fast-growing teams. Verified July 2026.",
    ...
    "ramp": dict(
        ...
        meta_desc="Ramp pricing 2026: Free Card = $0 forever, Plus = $15/user/mo ($12 annual). Bill Pay added June 2026 — no cost increase to core plan. Every change logged monthly with exact dates and source.",
        plans=[
