...
PRICING = {
    ...
    "ramp": dict(
        ...
        meta_desc="Ramp pricing change June 2026: Core card still $0 forever. Plus $15/user/mo ($12 annual). No headline change in 2026 — every fee and plan change tracked monthly with dates.",
        plans=[
