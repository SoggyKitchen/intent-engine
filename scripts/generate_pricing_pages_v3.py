...
PRICING = {
    ...
    "ramp": dict(
        ...
        meta_desc="Ramp pricing changes June 2026: Did Ramp raise prices? Core card still free forever. Plus $15/user/mo ($12/mo annual). Every pricing change tracked with dates and sources.",
        plans=[
