...
PRICING = {
    ...
    "ramp": dict(
        ...
        meta_desc="Ramp pricing June 2026: No change this month — Core card is free forever, Plus $15/user/mo ($12 annual). Every pricing update logged since launch. Zero hidden fees exposed.",
        plans=[
