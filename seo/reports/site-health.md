...
Generated: 2026-06-16T09:30:19+00:00
Mode: `apply-safe`

## Current Score
- Overall SaaSpare Health Score: **93.71/100**
...
## Dashboard Summary
- Pages scanned: 1452
- Healthy pages (85+): 1401
- Unhealthy pages (<55): 2
- OTTO import rows normalized: 18595
- Safe fixes applied this run: 1431
...
- `/pages/stripe-coupon-2026-discount-codes-promo` (coupon, score 86.04): CTA=True, affiliateLinks=1, disclosure=True
...
- `/pages/contabo-coupon-2026-discount-codes-promo` (coupon, score 91.98): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/amplitude-coupon-2026-discount-codes-promo` (coupon, score 92.0): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/datadog-coupon-code-promo-codes-2026-verified-discounts` (coupon, score 92.0): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/zendesk-coupon-code-promo-codes-2026-verified-discounts` (coupon, score 92.0): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/deel-coupon-code-promo-codes-2026-verified-discounts` (coupon, score 92.01): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/getresponse-coupon-2026-discount-codes-promo` (coupon, score 92.02): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/gusto-coupon-2026-discount-codes-promo` (coupon, score 92.02): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/hetzner-coupon-2026-discount-codes-promo` (coupon, score 92.02): CTA=True, affiliateLinks=1, disclosure=True
- `/pages/protonvpn-coupon-code-promo-codes-2026-verified-discounts` (coupon, score 92.02): CTA=True, affiliateLinks=1, disclosure=True
...
- `/pages/clearscope-coupon-2026-discount-codes-promo` (coupon, score 92.03): CTA=True, affiliateLinks=1, disclosure=True
