...
## Warning Counts
- canonical_mismatch: 16
- meta_length_outside_target: 16
- missing_correction_cta: 72
- missing_last_verified: 5
- missing_methodology: 16
- missing_related_pages: 37
- missing_trustbox: 36
- thin_buyer_page: 92
...
- `/pages/v3-preview-contact`: 61.8/100, issues=none
- `/pages/v3-preview-newsletter`: 62.8/100, issues=none
- `/pages/v3-preview-about`: 63.61/100, issues=none
- `/pages/v3-preview-shortlist`: 63.97/100, issues=none
...
- `/pages/v3-preview-roi-calculator`: 65.75/100, issues=none
...
- `/pages/v3-preview-deal-radar`: 66.48/100, issues=none
...
- `/pages/buyer-type-alternatives`: 68.61/100, issues=none
...
- `/pages/hidden-fee-detector`: 73.66/100, issues=none
...
- `/pages/v3-preview-comparison`: 75.22/100, issues=none
...
- `/pages/tresorit-vs-box-which-is-better-in-2026`: 80.8/100, issues=broken_internal_link
